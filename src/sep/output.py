...
def main():
  ...
  result = pinecone.query(query_vector, num_res_to_retrieve=12, namespace='better_article_data')    
  top_k_vectors = result['matches']
  print(f'usage: {result['usage']}')
  
  prompt_handler = PromptHandlerFactory.create_prompt_handler(LargeLanguageModels.GPT_5, max_response_words=5500)
